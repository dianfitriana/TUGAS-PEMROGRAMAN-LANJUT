				...
				if(pilihLokasi == 1){
					...
					for(i=1; i<=n; i++){
						if(!strcmp(a[i].almtnsb.kota,cariLokasi)){
							...
							printf("\nTTL nasabah(HH-BB-TT) ke-%d : %d %s %d ", i, a[i].ttlnsb.tanggal,a[i].ttlnsb.bulan,a[i].ttlnsb.tahun);
							printf("\nNo. rekening ke-%d          : %d", i, a[i].rekening); 
							printf("\nJumlah saldo ke-%d          : %d", i, a[i].saldo);
							printf("\n");
							flag++;
						}
					}
			...
			if(n==0){
				...
				for(i=1; i<=n; i++){
					if(a[i].ttlnsb.tahun == tahun){
						printf("\nNama bank nasabah ke-%d     : %s", i, a[i].bank);
						printf("\nNama nasabah ke-%d          : %s", i, a[i].nama); 
						printf("\nAlamat nasabah ke-%d        : %s", n, a[i].almtnsb.jalan);
						printf("\nKota nasabah ke-%d          : %s", n, a[i].almtnsb.kota);
						printf("\nProvinsi nasabah ke-%d      : %s", n, a[i].almtnsb.provinsi);
						printf("\nTTL nasabah(HH-BB-TT) ke-%d : %d %s %d ", n, a[i].ttlnsb.tanggal,a[i].ttlnsb.bulan,a[i].ttlnsb.tahun);
						printf("\nNo. rekening ke-%d          : %d", i, a[i].rekening); 
						printf("\nJumlah saldo ke-%d          : %d", i, a[i].saldo);
						printf("\n");
						flag++;
